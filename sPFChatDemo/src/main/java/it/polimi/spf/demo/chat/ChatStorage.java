...
public interface ChatStorage {
    ...
    long saveMessage(Message message, Conversation conversation);

    Conversation findConversationById(long conversationId);

    Conversation findConversationWith(String contactIdentifier);

    long saveConversation(Conversation conversation);

    void markAsRead(Conversation conversation);

    void deleteConversation(Conversation conversation);

    interface ConversationContract extends BaseColumns {
        String TABLE_NAME = "Conversations";
        String COLUMN_USER_IDENTIFIER = "user_id";
        String COLUMN_USER_DISPLAY_NAME = "display_name";
        String COLUMN_USER_PICTURE = "userPicture";
        String COLUMN_NUMBER_OF_UNREAD_MSG = "num_of_unread_msg";
        String COLUMN_UPDATED_AT = "updated_at";
        String COLUMN_FIRST_MESSAGE = "first_message";
    }

    interface MessageContract extends BaseColumns {
        String TABLE_NAME = "Messages";
        String COLUMN_CONVERSATION = "conversation_id";
        String COLUMN_USER_IDENTIFIER = "user_id";
    ...
    class ChatStorageImpl extends SQLiteOpenHelper implements ChatStorage {
         ...
         *
         * @param ctx - the Context in which the database should be created
         */
